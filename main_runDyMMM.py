...
#va1,va2,gammaa3,gammaa4,gammaa5,gammaa6,p1,p2,luxR,lasR,alpha1,alpha2,k1,k2,n,theta,beta,CSI,biomass1_SS,biomass1,biomass2_SS,biomass2
#4.189362581240542,2.927597307035691,120.66777979886093,79.20330152939339,84.12634139428867,43.10595565447185,4680513.201764763,73174940.2963288,0.00027452843538091926,0.00033329220858827865,141.3091638120059,489.21431642756636,95.60828576820556,97.4729383775986,1.5504766342586265,1.179402182307254e-06,4.402650302143001e-05,0.9829744468061882,0.8883079002695256,1.072629176888234,0.851413568221847,1.0353203030415097
#4.189362581240542,2.927597307035691,120.66777979886093,79.20330152939339,84.12634139428867,43.10595565447185,4680513.201764763,73174940.2963288,0.00027452843538091926,0.00033329220858827865,141.3091638120059,489.21431642756636,95.60828576820556,97.4729383775986,1.5504766342586265,1.179402182307254e-06,4.402650302143001e-05,0.9829744468061882,0.8883079002695256,1.072629176888234,0.851413568221847,1.0353203030415097
...
#     print(mu2)
#     if 'M3' in df.columns:
#         mu3=integrate.trapz(df['M3'],df.index)
#         df['MAX_M1_M2_M3'] = df[['M1','M2', 'M3']].max(axis=1)
#         denom=integrate.trapz(df['MAX_M1_M2_M3'],df.index)
#         CSI=1-(abs(mu1-mu2)+abs(mu2-mu3)+abs(mu3-mu1))/(3*denom)
#     else:
