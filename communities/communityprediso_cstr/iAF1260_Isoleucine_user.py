...
class iAF1260_Isoleucine_user(object):
    ...
    reactions=['BIOMASS_Ec_iML1515_core_75p37M','EX_glc__D_e','EX_his__L_e', 'EX_trp__L_e', 'EX_ile__L_e', 'HISTD','ILETA','ILEabcpp','ILEt3pp', 'ILEt2rpp']
    ...
    def __init__(self, community, modelDir):
        ...
        self.model_rnx['ILETA'].lower_bound = 0
        self.model_rnx['ILETA'].upper_bound = 0
        self.model_rnx['ILEabcpp'].lower_bound = 0
        self.model_rnx['ILEabcpp'].upper_bound = 0
        self.model_rnx['ILEt2rpp'].upper_bound = 1000
        self.model_rnx['ILEt2rpp'].lower_bound = 0
        self.model_rnx['ILEt3pp'].upper_bound = 0
        self.model_rnx['ILEt3pp'].lower_bound = 0 
    ...
    def updateUptakes(self):
        ...
        Vmax_ip = -k*y['G1']
        if Vmax_ip <= -0.255*2:
            Vmax_ip = -0.255*2 #0.253  #Assume Ks on glucose same as E. coli  
        else:
            Vmax_ip = -k*y['G1']
        self.model_rnx['ILETA'].lower_bound = Vmax_ip
        
        # isoleucine import 
        C = y['EX_ile__L_e']/y['Vol']
        vmaxiso = p['vmaxiso']
        if C >= 0:
            Vmax_ii = -vmaxiso*C/(C + 0.001)  #Assume Ks on glucose same as E. coli
        else:
            Vmax_ii = 0
        self.model_rnx['EX_ile__L_e'].lower_bound = Vmax_ii
        self.model_rnx['EX_ile__L_e'].upper_bound = 0
