...
class DyMMMCommunity(object):
    ...
    #list of metabolites
    mets=['EX_glc__D_e','EX_his__L_e', 'EX_iso__L_e', 'ILETA', 'HISTD']    #metabolites tracked by DMMM

    # states in community
    statesList = ['Vol', 'biomass3', 'biomass2', 'EX_glc__D_e','EX_his__L_e'
                 ,'EX_iso__L_e', 'A2', 'A3', 'R2', 'R3', 'G2', 'G3'] #A1 and A2 are mislabelled. 
    ...
    params = {
        ...
        'Xfeed1':0.0,
        'Xfeed2':0.0,
        'k3' : 51, #8.4 - used in model updateUptakes
    ...
    def calculateDerivates(self):
        ...
        biomass3_g = sp[0].F['BIOMASS_Ec_iML1515_core_75p37M']*y['biomass3']
        biomass2_g = sp[1].F['BIOMASS_Ec_iML1515_core_75p37M']*y['biomass2']

        self.dy['biomass3'] =  biomass3_g - (rVol)* y['biomass3']
        ...
        self.dy['EX_iso__L_e'] =  (rVol)*(p['Sfeed3']-y['EX_iso__L_e']) + (y['biomass1'] * sp[0].F['EX_iso__L_e']+ y['biomass2'] * sp[1].F['EX_iso__L_e'])   
        
        #interaction equations
        self.dy['A3'] = p['va1']*y['biomass1'] - p['gammaa1']*y['A3'] - ((rVol)* y['A3']) #A1
        
        self.dy['A2'] =  p['va2']*y['biomass2'] - p['gammaa2']*y['A2']-((rVol)* y['A2']) #A2
        
        self.dy['R3'] = p['p1'] *y['A3']**2*p['luxR']**2 - p['gammaa3']*y['R3'] - sp[1].F['BIOMASS_Ec_iML1515_core_75p37M']*y['R3']
        
        self.dy['R2'] = p['p2'] *y['A2']**2*p['lasR']**2 - p['gammaa4']*y['R2'] - sp[0].F['BIOMASS_Ec_iML1515_core_75p37M']*y['R2']
        
        self.dy['G3'] = (p['alpha1'] * (1-numpy.exp(-sp[0].F['BIOMASS_Ec_iML1515_core_75p37M']/0.33))) /(1+ (y['R2']/p['theta'])**p['n']) - p['gammaa5']*y['G3'] - sp[0].F['BIOMASS_Ec_iML1515_core_75p37M']*y['G3']
