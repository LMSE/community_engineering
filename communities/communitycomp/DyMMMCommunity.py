...
class DyMMMCommunity(object):
    ...
    initialConditions=numpy.array([1,0.01,0.01,5000,0.001,0.001,0.0005,0.0005,0.0001,00.0001,0.0001,0.0001])

    def initializeState(self):
        self.initialConditions=numpy.array([1,0.01,0.01,5000,0.001,0.001,0.0005,0.0005,0.0001,00.0001,0.0001,0.0001])
        self.t=0
        self.last_t=0
    ...
    def calculateDerivates(self):
        ...
        self.dy['biomass2'] = sp[1].F['BIOMASS_Ec_iML1515_core_75p37M']*(((K-y['biomass2'])/K))*y['biomass2']-kd*y['biomass1'] + p['Fin']/y['Vol']*(p['Xfeed2'] - y['biomass2'])
        ...
        self.dy['A2'] =  p['va2']*y['biomass2'] - p['gammaa2']*y['A2'] #A2
