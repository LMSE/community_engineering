...
"""
calculates the Jacobian matrix and its eigenvalues for a dynamic model of microbial community interactions to assess system stability. It defines 
functions for steady-state determination, and processes simulation results from the community model. 
The program subsequently calculates the Jacobian and its eigenvalues at the steady state and saves the eigenvalues for further analysis. 
"""
...
def getSteadyStateValues(fileName):
    ...
    #df.drop(['time','M1','M2','M3'], axis=1, inplace=True
...
if __name__ == '__main__':
    ...
    global stateNames
    stateNames=community.statesList
